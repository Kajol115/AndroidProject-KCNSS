...
public class ImageListView extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public static final String GET_IMAGE_URL="https://nsspro.000webhostapp.com/getimgserver.php";
    ...
    private void getImages(){
        class GetImages extends AsyncTask<Void,Void,Void> {
            ...
            protected void onPostExecute(Void v) {
                ...
                // Toast.makeText(ImageListView.this,v.toString(), Toast.LENGTH_LONG).show();
                CustomList customList = new CustomList(ImageListView.this,GetAlImages.imageURLs,GetAlImages.names,GetAlImages.bitmaps);
